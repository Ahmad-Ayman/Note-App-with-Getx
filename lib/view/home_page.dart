...
import 'package:newnote/widgets/alertDialog.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<NoteController>(
        builder: (_) {
          log('Notes are : ${controller.notes.length}');
          return controller.notes.isEmpty ? emptyNotes() : viewNotes();
        },
      ),
